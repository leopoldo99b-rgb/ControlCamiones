...
public class UsuarioController {
    ...
    /* 
     * Se añade "" al GetMapping para que la URL /usuarios 
     * se asocie a este método y no a un recurso estático.
     */
    @GetMapping("")
    public String usuarios(Model model) {
        ...
        model.addAttribute("limiteUsuarios", LIMITE_USUARIOS);
        ...
        if (id != null) {
            ...
            if (imagen != null && !imagen.isEmpty()) {
                if (usuario.getImagenPerfil() != null && !usuario.getImagenPerfil().isBlank()) {
                    cloudinaryService.eliminarImagen(usuario.getImagenPerfil());
                }
                String nuevaImagen = cloudinaryService.subirImagen(imagen);
    ...
    public String eliminarUsuario(@PathVariable Long id) throws IOException {
    ...
    @ResponseBody
    public Set<Permiso> obtenerPermisos(@PathVariable Long id) {
